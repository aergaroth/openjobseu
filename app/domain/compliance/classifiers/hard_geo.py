...
HARD_GEO_PATTERNS = [
    ...
    r"\bmust be located in north america\b",
    r"\bmust be based in north america\b",
    r"\bmust reside in north america\b",
    ...
    r"\bmust be located in apac\b",
    r"\bmust be based in apac\b",
    r"\bmust reside in asia.?pacific\b",
    r"\bmust be located in asia.?pacific\b",
    r"\bmust be based in asia.?pacific\b",
    r"\bwithin apac only\b",
    r"\bbased (?:remotely )?in the apac region\b",
    r"\blocated (?:remotely )?in the apac region\b",
    r"\bremotely in the apac region\b",
    r"\bbased (?:remotely )?in the asia.?pacific region\b",
    r"\baustralia only\b",
    r"\baustralian residents only\b",
    r"\bmust reside in australia\b",
    r"\bmust be located in australia\b",
    r"\bmust be based in australia\b",
    r"\bindia only\b",
    r"\bindian residents only\b",
    r"\bmust reside in india\b",
    r"\bmust be located in india\b",
    r"\bmust be based in india\b",
]
