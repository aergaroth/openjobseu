...
def extract_structured_salary(job: dict) -> dict | None:
    ...
    for field in SALARY_FIELDS:
        ...
        if isinstance(data, dict):
            ...
            try:
                min_val = int(float(min_val)) if min_val is not None else None
                max_val = int(float(max_val)) if max_val is not None else None
            ...
            return {
                ...
                "salary_period": "year",  # Default assumption for structured ATS data
